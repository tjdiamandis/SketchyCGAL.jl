...
function run_trials_weights(G; R=10, max_iters=10_000, print_iter=1000)
    trial_data = Dict()
    C, b, A!, A_adj!, n, d, scale_X, scale_C = setup_maxcut_scgal(G)
...
trial_data_weights = run_trials_weights(G; max_iters=10_000, print_iter=1000)
BSON.bson(joinpath(@__DIR__, "output/trials_weights.bson"), trial_data_weights)
